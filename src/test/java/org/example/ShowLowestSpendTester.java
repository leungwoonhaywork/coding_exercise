...
import org.example.function.ShowLowestSpend;
...
public class ShowLowestSpendTester {
    public static ShowLowestSpend showLowestSpend;
    ...
    public static void setClass() throws Exception {
        showLowestSpend = new ShowLowestSpend();
    }
    ...
    public void setup() {
        ...
        result = showLowestSpend.addSpend(showLowestSpend.filterData(categories, "Groceries", 2020));
        maxResult = showLowestSpend.findMin(result);
    }
    ...
    public void testResult() {
        Assertions.assertEquals(1.99f, maxResult);
    }
